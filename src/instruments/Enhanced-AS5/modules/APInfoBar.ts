export class APInfoBar extends HTMLElement {
    ...
    divider: Element
    divider2: Element
    AP_LateralArmed: Element
    AP_LateralActive: Element
    AP_Status: Element
    AP_VerticalActive: Element
    AP_ModeReference: Element
    AP_Armed: Element
    AP_ArmedReference: Element
